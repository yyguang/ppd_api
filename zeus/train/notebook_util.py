...
def pick_gpu_lowest_memory(count = 1):
    ...
    if count == 1:
        ...
        #best_memory, best_gpu = sorted(memory_gpu_map)[0:count]
        best_gpu = []
        sorted_gpu_map = sorted(memory_gpu_map)
        for i in range(count):
            best_gpu.append(sorted_gpu_map[i][1])
    return best_gpu
