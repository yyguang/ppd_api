...
# model: inceptionV3/xception/resnet50/mobilenetv2_1.40_224/inception_resnet_v2/PATH_TO_LAST_BEST_MODEL(hdf5 file)
# recommend to finetune from last best model, which is much quicker than imagenet weight
exp_name="violence-new0402"
dataset="/data/project/violence20180324"
dense_units=1024
model='inception_v3'
# train mode: 0 for normal train mode, 1 for quick train mode
quickly_ft=0
